...
for h in range(	0, 24):
    for n in range(0, 128):
        file_keys.append('merged_logs/%02d/%02d/part-00%03d_negatives_pt2_percent.gz' % (1, h , n))
    combined_keys.append('merged_logs/%02d/%02d/combined_negatives_pt2_percent.gz' % (1, h))
